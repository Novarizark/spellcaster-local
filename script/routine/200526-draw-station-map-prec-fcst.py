...
def main():
    ...
    ax.scatter( lon_dic['p2'], lat_dic['p2'],marker='.', color='darkblue', 
            s=40,zorder=0, transform=ccrs.Geodetic(), label='>50% Sta_Num:'+str(len(lon_dic['p2'])))
    # +
    ax.scatter( lon_dic['p1'], lat_dic['p1'],marker='.', color='blue', 
            s=15,zorder=1, transform=ccrs.Geodetic(), label='20%~50% Sta_Num:'+str(len(lon_dic['p1'])))
    # +o
    ax.scatter( lon_dic['p0'], lat_dic['p0'],marker='.', color='aqua', 
            s=8,zorder=2, transform=ccrs.Geodetic(), label='0~20% Sta_Num:'+str(len(lon_dic['p0'])))
    # -o
    ax.scatter( lon_dic['p-0'], lat_dic['p-0'],marker='.', color='tan', 
            s=10,zorder=2, transform=ccrs.Geodetic(), label='-20%~0 Sta_Num:'+str(len(lon_dic['p-0'])))
    # -
    ax.scatter( lon_dic['p-1'], lat_dic['p-1'],marker='.', color='chocolate', 
            s=20,zorder=1, transform=ccrs.Geodetic(), label='-50%~-20% Sta_Num:'+str(len(lon_dic['p-1'])))
    # --
    ax.scatter( lon_dic['p-2'], lat_dic['p-2'],marker='.', color='darkred', 
            s=50,zorder=0, transform=ccrs.Geodetic(), label='<-50% Sta_Num:'+str(len(lon_dic['p-2'])))
    ...
    plt.savefig("../../fig/realtime.prec.png", dpi=200, bbox_inches='tight')
#    plt.show()
